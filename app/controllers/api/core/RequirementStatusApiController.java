...
public class RequirementStatusApiController extends ApiController {
     ...
     */
    @ApiAuthentication(additionalCheck = ApiAuthenticationBizdockCheck.class)
    @ApiOperation(value = "Get the specified Requirement Status", notes = "Return the Requirement Status with the specified id",
            response = RequirementStatus.class, httpMethod = "GET")
