...
/**
 * The pickers for the org units.
 * 
 * @author Johann Kohler
 */
public class OrgUnitPicker {

    public static PickerHandler<Long> canSponsorPickerTemplate = new PickerHandler<Long>(Long.class, new PickerHandler.Handle<Long>() {
    ...
    public static PickerHandler<Long> canDeliverPickerTemplate = new PickerHandler<Long>(Long.class, new PickerHandler.Handle<Long>() {
