...
/**
 * The pickers for releases.
 * 
 * @author Johann Kohler
 */
public class ReleasePicker {

    public static PickerHandler<Long> allActiveTemplate = new PickerHandler<Long>(Long.class, new PickerHandler.Handle<Long>() {
