            ...
            return new Table<WorkOrderListView>() {
                {
                    ...
                    setJavaColumnFormatter("shared", new BooleanFormatter<>());

                    addColumn("isOpex", "isOpex", "object.work_order.expenditure_type.label", Table.ColumnDef.SorterType.NONE);
                    setJavaColumnFormatter("isOpex", (workOrderListView, value) -> views.html.modelsparts.display_is_opex.render(workOrderListView.isOpex).body());
                    ...
                    addSummableColumn("amount", "amount", "object.work_order.amount.label", Table.ColumnDef.SorterType.NONE);
                    ...
                    addSummableColumn("amountReceived", "amountReceived", "object.work_order.amount_received.label", Table.ColumnDef.SorterType.NONE);
                    setJavaColumnFormatter("amountReceived", new NumberFormatter<>(NumberFormatter.CURRENCY_PATTERN));
                    setColumnValueCssClass("amountReceived", "text-right");
                    setColumnHeaderCssClass("amountReceived", "text-right");

                    addColumn("planningPackage", "planningPackage", "object.work_order.portfolio_entry_planning_package.label",
                            Table.ColumnDef.SorterType.NONE);
                    setJavaColumnFormatter("planningPackage", (workOrderListView, value) -> views.html.modelsparts.display_portfolio_entry_planning_package.render(workOrderListView.planningPackage).body());
                    ...
                    setJavaColumnFormatter("dueDate", new DateFormatter<>());
                    ...
                    setJavaColumnFormatter("selectLineItemActionLink", (workOrderListView, value) -> {
                    ...
                    setJavaColumnFormatter("engageWorkOrder", (workOrderListView, value) -> {
                        if (!workOrderListView.fromResource) {
                            String url = controllers.core.routes.PortfolioEntryFinancialController
                    ...
                    setJavaColumnFormatter("editActionLink",
                            new StringFormatFormatter<>(IMafConstants.EDIT_URL_FORMAT, (StringFormatFormatter.Hook<WorkOrderListView>) workOrderListView -> routes.PortfolioEntryFinancialController
                                    .manageWorkOrder(workOrderListView.portfolioEntryId, workOrderListView.id).url()));
                    setColumnCssClass("editActionLink", IMafConstants.BOOTSTRAP_COLUMN_1);
                    setColumnValueCssClass("editActionLink", IMafConstants.BOOTSTRAP_TEXT_ALIGN_RIGHT + " rowlink-skip");

                    addColumn("deleteActionLink", "id", "", Table.ColumnDef.SorterType.NONE);
                    setJavaColumnFormatter("deleteActionLink", (workOrderListView, value) -> {
                        if (!workOrderListView.fromResource) {
                    ...
                    this.setLineAction((workOrderListView, value) -> routes.PortfolioEntryFinancialController
