...
public class PortfolioEntryResourcePlanAllocatedOrgUnitListView {
    ...
    public static Table<PortfolioEntryResourcePlanAllocatedOrgUnitListView> templateTable = getTable();

    /**
     * Get the table.
     */
    public static Table<PortfolioEntryResourcePlanAllocatedOrgUnitListView> getTable() {
