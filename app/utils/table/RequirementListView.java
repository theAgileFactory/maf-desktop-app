...
public class RequirementListView {
    ...
    public static FilterConfig<RequirementListView> filterConfig = getFilterConfig();

    /**
     * Get the filter config.
     */
    public static FilterConfig<RequirementListView> getFilterConfig() {
        return new FilterConfig<RequirementListView>() {
            {
                ...
                addColumnConfiguration("externalRefId", "externalRefId", "object.requirement.external_ref_id.label", new TextFieldFilterComponent("*"), true,
    ...
    public static Table<RequirementListView> templateTable = getTable();

    /**
     * Get the table.
     */
    public static Table<RequirementListView> getTable() {
