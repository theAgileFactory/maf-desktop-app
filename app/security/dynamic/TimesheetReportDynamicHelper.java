...
public class TimesheetReportDynamicHelper {
    ...
    public static ExpressionList<TimesheetReport> getTimesheetReportsApprovalAllowedAsQuery(Expression expression, OrderBy<TimesheetReport> orderBy)
        ...
        // OR
        if (DeadboltAnalyzer.hasRole(userAccount, IMafConstants.TIMESHEET_APPROVAL_ALL_PERMISSION)) {
            raw += "1 = '1' OR ";
        }
        ...
        if (actor != null && DeadboltAnalyzer.hasRole(userAccount, IMafConstants.TIMESHEET_APPROVAL_AS_MANAGER_PERMISSION)) {
